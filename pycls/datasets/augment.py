...
def apply_op(im, op, prob, magnitude):
    """Apply op to image with given probability, magnitude, and standard deviation."""
...
def make_augment(augment_str):
    """Generate augmentation function from parameter string."""
    # Example valid param strings are "AutoAugment", "RandAugment_N2_M0.5"
    if not augment_str:
        return lambda im: im
